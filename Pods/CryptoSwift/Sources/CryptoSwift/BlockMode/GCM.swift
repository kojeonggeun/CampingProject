...
final class GCMModeWorker: BlockModeWorker, FinalizingEncryptModeWorker, FinalizingDecryptModeWorker {
  ...
  init(iv: ArraySlice<UInt8>, aad: ArraySlice<UInt8>? = nil, expectedTag: [UInt8]? = nil, tagLength: Int, mode: GCM.Mode, cipherOperation: @escaping CipherOperationOnBlock) {
    ...
    self.tagLength = tagLength
    self.h = UInt128(cipherOperation([UInt8](repeating: 0, count: self.blockSize).slice)!) // empty block
...
private final class GF {
  ...
  private static func calculateX(block ciphertextBlock: [UInt8], x: UInt128, h: UInt128, blockSize: Int) -> UInt128 {
